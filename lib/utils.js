const sqlRetrieveAllUsers =
`SELECT card.msisdn, reseller.id as reseller_id, reseller.name, reseller.sip_hostname, reseller.sip_user_agent,  reseller.disable_fmc_failover, 
